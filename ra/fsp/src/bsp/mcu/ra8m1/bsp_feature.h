...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS_MASK                            (0x000F01FFUL)  // Mask of available channels in ADC unit 0.
#define BSP_FEATURE_ADC_UNIT_1_CHANNELS_MASK                            (0x007F007FUL)  // Mask of available channels in ADC unit 1.
...
#define BSP_FEATURE_GPT_32BIT_CHANNEL_MASK                              (0xFFUL)        // Mask of 32-bit GPT channel indices.
#define BSP_FEATURE_GPT_AD_CONVERSION_START_CHANNEL_MASK                (0xFFUL)        // Mask of GPT channels supporting A/D conversion start.
...
#define BSP_FEATURE_ICU_WUPEN_MASK                                      (0x00007F08FF1DFFFFULL) // A mask of valid bits for [WUPEN1:WUPEN0].
...
#define BSP_FEATURE_LPM_DPSIER_MASK                                     (0xAF1FFFFFULL) // Mask of valid bit-fields of the DPSIERn registers.
