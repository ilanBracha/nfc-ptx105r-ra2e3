...
#ifndef AUC_NFC_CARD_READER_LOG_H_
#define AUC_NFC_CARD_READER_LOG_H_
 ...
 */
typedef void (* auc_nfc_card_reader_log_rx_callback_t)(uint8_t byte);
...
#endif /* AUC_NFC_CARD_READER_LOG_H_ */
